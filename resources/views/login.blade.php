...
<div class="d-flex flex-column flex-root" id="kt_app_root">
	<!--begin::Page bg image-->
	<style>body { background-image: url('includes/bg-theme-7b32b5c5-left.png'); } [data-bs-theme="dark"] body { background-image: url('includes/bg-theme-7b32b5c5-left.png'); }</style>
	<!--end::Page bg image-->
		...
		<div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
			...
			<div class="d-flex flex-center flex-lg-start flex-column">
				...
				<a href="../../demo1/dist/index.html" class="mb-7">
					<img alt="Logo" src="includes/logo-furgoni-2.svg" />
				</a>
				<!--end::Logo-->
				<!--begin::Title-->
