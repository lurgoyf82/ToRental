<?php
	...
	//Revisione::getAlerts();
	$expiring=$expiringScadenzeBolli;
	$alert_revisione_meccanica='alert_scadenza_bollo';
?>
	<!--begin::Main-->
									...
									>
										...
										<td class="text-end w-100px">
											...
											<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-success fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
												<!--begin::Menu item-->
												<a href="create_bollo/{{$row->id_veicolo}}" class="btn btn-success">
													<span class="indicator-label">Revisiona Mezzo</span>
												</a>
												<!--end::Menu item-->
												@if($row->id)
													<!--begin::Menu item-->
													<a href="update_bollo/{{$row->id}}" class="btn btn-danger">
