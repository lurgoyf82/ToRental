<?php
	...
	//Revisione::getAlerts();
	$expiring=$expiringRevisioniBombole;
	$alert_revisione_bombole='alert_revisione_bombole';
?>
	<!--begin::Main-->
<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
	<!--begin::Content wrapper-->
	<div class="d-flex flex-column flex-column-fluid">
		<form action="{{ url($alert_revisione_bombole) }}" method="get">
			<!--begin::Content-->
						...
						<div class="card-body pt-0">
							...
							<table class="table text-center align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
								...
								<tr class="text-gray-400 fw-bold fs-7 text-uppercase gs-0">
									<th class="min-w-150px"><a href="{{ generate_order_url($alert_revisione_bombole, 'livello') }}">Livello</a></th>
									<th class="min-w-150px"><a href="{{ generate_order_url($alert_revisione_bombole, 'targa') }}">Targa</a></th>
									<th class="min-w-150px"><a href="{{ generate_order_url($alert_revisione_bombole, 'marca') }}">Marca</a></th>
									<th class="min-w-150px"><a href="{{ generate_order_url($alert_revisione_bombole, 'modello') }}">Modello</a></th>
								...
								@foreach($expiring as $row)
									...
									>
										...
										<td class="min-w-150px">
											<!-- <a href="update_bombole/{{ $row->id_veicolo }}" class="text-gray-800 text-hover-white mb-1"> -->
										...
										<td class="text-end w-100px">
											...
											<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-success fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
												<!--begin::Menu item-->
												<a href="create_bombole/{{$row->id_veicolo}}" class="btn btn-success">
													<span class="indicator-label">Revisiona Mezzo</span>
												</a>
												<!--end::Menu item-->
												@if($row->id)
													<!--begin::Menu item-->
													<a href="update_bombole/{{$row->id}}" class="btn btn-danger">
