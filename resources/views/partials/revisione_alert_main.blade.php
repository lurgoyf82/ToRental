        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Lista Alerts Revisione</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Alerts Revisione</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-850px ps-12" placeholder="Ricerca Targa / Numero Telaio" />
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                        <!--begin::Submit-->
                                        <button type="submit" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Ricerca</button>
                                        <!--end::Submit-->
                                    </div>
                                    <!--end::Toolbar-->
                                </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                            ...
                            <tr>
                                <td class="min-w-150px">
                                    <a href="update_veicolo/1" class="text-gray-800 text-hover-primary mb-1">Targa</a>
                                </td>
                                <td class="min-w-150px">
                                    <a href="update_marca/1" class="text-gray-800 text-hover-primary mb-1">Marca</a>
                                </td>
                                <td class="min-w-150px">
                                    <a href="update_modello/1" class="text-gray-800 text-hover-primary mb-1">Modello</a>
                                </td>
                                <td class="min-w-150px">
                                    <a href="update_revisione/1" class="text-gray-800 text-hover-primary mb-1">Inizio Validit&agrave;</a>
                                </td>
                                <td class="min-w-150px">
                                    <a href="update_revisione/1" class="text-gray-800 text-hover-primary mb-1">Fine Validit&agrave;</a>
                                </td>
