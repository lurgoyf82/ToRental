            ...
            <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
                ...
                <div id="kt_app_sidebar_menu_scroll" class="scroll-y my-5 mx-3" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
                    ...
                    <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                        <!--begin:Menu item-->
                        <div data-kt-menu-trigger="click" class="menu-item here  {{ (request()->is('alert_leasing')||
                                                       request()->is('alert_assicurazione')||
                                                       request()->is('alert_bollo')||
                                                       request()->is('alert_revisione')||
                                                       request()->is('alert_tagliando')) ? 'show' : '' }}" menu-accordion">
                            <!--begin:Menu link-->
                            <span class="menu-link {{ (request()->is('alert_leasing')||
                                                       request()->is('alert_assicurazione')||
                                                       request()->is('alert_bollo')||
                                                       request()->is('alert_revisione')||
                                                       request()->is('alert_tagliando')) ? 'active' : '' }}">
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link {{ (request()->is('alert_leasing')) ? 'active' : '' }}" href="alert_leasing">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link {{ (request()->is('alert_assicurazione')) ? 'active' : '' }}" href="alert_assicurazione">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link {{ (request()->is('alert_bollo')) ? 'active' : '' }}" href="alert_bollo">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link {{ (request()->is('alert_tagliando')) ? 'active' : '' }}" href="alert_tagliando">
