                    ...
                    <div id="kt_app_content_container" class="app-container container-xxl">
                        ...
                        <div class="card">
                                ...
                                <div class="card-title">
                                    ...
                                    <div class="d-flex align-items-center position-relative my-1">
                                        ...
                                        <input type="text" name="search" value="{{ request('search') }}"
                                               class="form-control form-control-solid w-850px ps-12"
                                               placeholder="Ricerca Targa"/>
                            ...
                            <div class="card-body pt-0">
                                <!--begin::Table-->
                                <table class="table text-center align-middle table-row-dashed fs-6 gy-5"
                                    ...
                                    @foreach($expiringRevisioniTachigrafi as $row)
                                            <?php
                                            ...
                                            ?>
                                        <tr @if($row->livello<=Alert::$firstThreshold)
                                            ...
                                            <td class="min-w-150px">
                                                <a href="update_veicolo/{{ $row->id_veicolo }}"
                                                   class="text-gray-800 text-hover-white mb-1">{{ $row->targa ?? 'N/A' }}</a>
                                            </td>
                                            <td class="min-w-150px">
                                                <a href="update_marca/{{ $row->id_marca }}"
                                                   class="text-gray-800 text-hover-white mb-1">{{ $row->marca ?? 'N/A' }}</a>
                                            </td>
                                            <td class="min-w-150px">
                                                <a href="update_modello/{{ $row->id_modello }}"
                                                   class="text-gray-800 text-hover-white mb-1">{{ $row->modello ?? 'N/A' }}</a>
                                            </td>
                                            <td class="min-w-150px">
                                                <a href="update_revisione/{{ $row->id }}"
                                                   class="text-gray-800 text-hover-white mb-1">{{ $row->inizio_validita ?? 'N/A' }}</a>
                                            </td>
                                            <td class="min-w-150px">
                                                <a href="update_revisione/{{ $row->id }}"
                                                   class="text-gray-800 text-hover-white mb-1">{{ $row->fine_validita ?? 'N/A' }}</a>
                                            </td>
